...
export default function DemandForecastPage() {
  ...
  return (
    <Box sx={{ p: 4 }}>
      <Stack spacing={3}>
        <Typography variant="h4" fontWeight={700}>Demand Forecast</Typography>
        ...
        {data ? (
          <>
            ...
            <ChartCard title="Booking Demand: History + Forecast" type="line" data={data.trend} />
          </>
        ) : null}
      </Stack>
    </Box>
